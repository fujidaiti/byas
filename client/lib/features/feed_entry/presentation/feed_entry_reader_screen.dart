...
///
/// The archived state lives in [feedEntryControllerProvider], so toggling it
/// also updates the "Archived" banner below the app bar. Membership (`_saved`)
/// stays local because a save is confirmed optimistically before the server
...
class _ReadingListActionsState extends ConsumerState<_ReadingListActions> {
  ...
  Widget build(BuildContext context) {
    final archived = widget.entry.archived ?? false;
    return Row(
