...
mixin _$ReadingListItem {
 ...
 int get id; String get title; DateTime get savedAt; String? get description;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReadingListItem&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.savedAt, savedAt) || other.savedAt == savedAt)&&(identical(other.description, description) || other.description == description));
}


@override
int get hashCode => Object.hash(runtimeType,id,title,savedAt,description);

@override
String toString() {
  return 'ReadingListItem(id: $id, title: $title, savedAt: $savedAt, description: $description)';
}
...
@useResult
$Res call({
 int id, String title, DateTime savedAt, String? description
});
...
/// Create a copy of ReadingListItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? savedAt = null,Object? description = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  DateTime savedAt,  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReadingListItem() when $default != null:
return $default(_that.id,_that.title,_that.savedAt,_that.description);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  DateTime savedAt,  String? description)  $default,) {final _that = this;
switch (_that) {
case _ReadingListItem():
return $default(_that.id,_that.title,_that.savedAt,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  DateTime savedAt,  String? description)?  $default,) {final _that = this;
switch (_that) {
case _ReadingListItem() when $default != null:
return $default(_that.id,_that.title,_that.savedAt,_that.description);case _:
  return null;
...
class _ReadingListItem implements ReadingListItem {
  const _ReadingListItem({required this.id, required this.title, required this.savedAt, this.description});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReadingListItem&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.savedAt, savedAt) || other.savedAt == savedAt)&&(identical(other.description, description) || other.description == description));
}
...
/// Create a copy of ReadingListItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? savedAt = null,Object? description = freezed,}) {
